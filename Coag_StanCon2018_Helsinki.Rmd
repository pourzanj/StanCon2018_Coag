...
In our case is data consists of hitting times like $R$, which is the time the clot takes to reach a size of
20 mm, and we instead set up a probabilistic model, or likelihood of the form
