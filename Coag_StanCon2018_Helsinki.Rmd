...
Once our model is fit we make sure to check our MCMC diagnostics, to ensure the integrity of our samples. In particular we make sure that there are no divergence or max tree depth warnings, and that the $\hat{R}$ value for all of the sample parameters is below 1.01. 
